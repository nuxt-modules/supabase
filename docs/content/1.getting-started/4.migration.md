...
::tip
For production deployments, you can use `NUXT_PUBLIC_SUPABASE_KEY` and `NUXT_SUPABASE_SECRET_KEY` to override values at runtime without rebuilding. See the [introduction](/getting-started/introduction) for details.
::
