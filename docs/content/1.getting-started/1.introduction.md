...
`~/` resolves to your Nuxt [srcDir](https://nuxt.com/docs/api/nuxt-config#srcdir): the `app/` directory when present (Nuxt 4 default), otherwise the project root (Nuxt 3 or Nuxt 4 without an `app/` directory).
